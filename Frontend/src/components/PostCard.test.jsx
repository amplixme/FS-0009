...
const mockPost = {
  ...
  content:
    'React sigue siendo una de las librerías más usadas para construir interfaces de usuario modernas y reactivas.',
...
describe('PostCard', () => {
  ...
  it('renderiza el extracto (contenido) del post', () => {
    renderPostCard();
    expect(screen.getByText(/React sigue siendo una de las librerías/i)).toBeInTheDocument();
  });
